...
public class CursoController {
    ...
    public String listarAlumnos() {
        return "alumnosView"; // Asegúrate de que existe alumnosView.html en /templates
    }
    ...
    public String listar(Model model) {
        ...
        return "listarCursoView";
    }

    @GetMapping("/buscar")
    public String buscar(@RequestParam("keyword") String keyword, Model model) {
        model.addAttribute("titulo", "Resultados de búsqueda para: " + keyword);
        model.addAttribute("cursos", servicio.buscarPorNombre(keyword));
        return "listarCursoView";
    }
